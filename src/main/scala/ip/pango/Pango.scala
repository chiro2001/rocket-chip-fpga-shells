...
//========================================================================
// This file contains common devices used by our Pango FPGA flows and some
// BlackBox modules used in the Pango FPGA flows
//========================================================================

//-------------------------------------------------------------------------
// mmcm
//-------------------------------------------------------------------------
/** mmcm: This is generated by the Pango IP Generation Scripts */
...
// reset_sys
//-------------------------------------------------------------------------
/** reset_sys: This is generated by the Pango IP Generation Scripts */
...
// reset_mig
//-------------------------------------------------------------------------
/** reset_mig: This is generated by the Pango IP Generation Scripts */
...
class vcu118_sys_clock_mmcm0 extends BlackBox {
  ...
  ElaborationArtefacts.add(
    ...
    """create_ip -name clk_wiz -vendor pango.com -library ip -module_name vcu118_sys_clock_mmcm0 -dir $ipdir -force
    set_property -dict [list \
    CONFIG.CLK_IN1_BOARD_INTERFACE {Custom} \
    CONFIG.PRIM_SOURCE {No_buffer} \
...
class vcu118_sys_clock_mmcm1 extends BlackBox {
  ...
  ElaborationArtefacts.add(
    ...
    """create_ip -name clk_wiz -vendor pango.com -library ip -module_name vcu118_sys_clock_mmcm1 -dir $ipdir -force
    set_property -dict [list \
    CONFIG.CLK_IN1_BOARD_INTERFACE {Custom} \
    CONFIG.PRIM_SOURCE {No_buffer} \
    CONFIG.CLKOUT2_USED {true} \
